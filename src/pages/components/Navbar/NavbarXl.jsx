              ...
              <li class="nav-item">
                <a class="nav-link" href="dashboard/lms.html">
                  <div class="d-flex align-items-center">
                    ...
                    <span class="badge rounded-pill ms-2 badge-subtle-success">
                      New
                    </span>
                  </div>
                </a>
          ...
          <li class="nav-item">
            ...
            <ul class="nav collapse" id="components">
              ...
              <li class="nav-item">
                ...
                >
                  <div class="d-flex align-items-center">
                    <span class="nav-link-text ps-1">Bottom bar</span>
                    <span class="badge rounded-pill ms-2 badge-subtle-success">
                      New
                    </span>
                  </div>
              ...
              <li class="nav-item">
                ...
                >
                  <div class="d-flex align-items-center">
                    <span class="nav-link-text ps-1">Jquery</span>
                    <span class="badge rounded-pill ms-2 badge-subtle-success">
                      New
                    </span>
                  </div>
              ...
              <li class="nav-item">
                <a class="nav-link" href="modules/components/sortable.html">
                  <div class="d-flex align-items-center">
                    <span class="nav-link-text ps-1">Sortable</span>
                  </div>
                </a>
              </li>
              <li class="nav-item">
