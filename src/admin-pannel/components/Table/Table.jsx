          ...
          <div className="card-header border-bottom border-200 px-0">
            <div className="d-lg-flex justify-content-between">
              ...
              <div className="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                <button className="btn btn-sm btn-falcon-default d-xl-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#ticketOffcanvas" aria-controls="ticketOffcanvas">
                  <span className="fas fa-filter" data-fa-transform="shrink-4 down-1"></span>
                ...
                {isAnyCheckboxChecked ? (
                  ...
                  <div className="d-flex align-items-center" id="table-ticket-replace-element">
                    <div className="dropdown">
                      <button className="btn btn-sm btn-falcon-default dropdown-toggle dropdown-caret-none" type="button" id="ticket-layout" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent">
                        <span className="d-none d-sm-inline-block d-xl-none d-xxl-inline-block me-1">Table View</span>
                        <span className="fas fa-chevron-down" data-fa-transform="shrink-3 down-1"></span>
                      </button>
                      <div className="dropdown-menu dropdown-toggle-item dropdown-menu-end border py-2" aria-labelledby="ticket-layout">
                        <a className="dropdown-item active" href="table-view.html">Table View</a>
                        <a className="dropdown-item" href="card-view.html">Card View</a>
                      </div>
                    </div>
                    <button className="btn btn-falcon-default btn-sm mx-2" type="button">
                      <span className="fas fa-plus" data-fa-transform="shrink-3"></span>
                      <span className="d-none d-sm-inline-block d-xl-none d-xxl-inline-block ms-1">New</span>
                    </button>
                    <button className="btn btn-falcon-default btn-sm" type="button">
                      <span className="fas fa-external-link-alt" data-fa-transform="shrink-3"></span>
                    ...
                    <div className="dropdown font-sans-serif ms-2">
                      <button className="btn btn-falcon-default text-600 btn-sm dropdown-toggle dropdown-caret-none" type="button" id="preview-dropdown" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false">
                        <span className="fas fa-ellipsis-h fs-11"></span>
                      </button>
                      <div className="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="preview-dropdown">
                ...
                <thead className="bg-body-tertiary">
                  <tr>
                    ...
                    {tableColumns.map((col, index) => (
                      <th key={index} scope="col" className="text-800 sort align-middle">
                        {col.tableHeader}
                      </th>
                    ))}
